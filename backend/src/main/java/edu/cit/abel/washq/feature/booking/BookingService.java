...
import edu.cit.abel.washq.feature.catalog.ServiceDTO;
...
import edu.cit.abel.washq.feature.timeslot.TimeSlotDTO;
...
public class BookingService {
    ...
    public BookingResponseDTO createBooking(String userEmail, BookingRequestDTO request) {
        ...
        WashService service = serviceRepository.findById(request.getServiceId())
    ...
    private BookingResponseDTO mapToDTO(Booking booking) {
        ...
        WashService service = booking.getService();
        if (service != null) {
